...
List.prototype = {
  ...
  removeLeadsFromList: function(listId, leadIds) {
    ...
    var path = util.createPath('lists', listId, 'leads.json');
    return this._connection.del(path, {query: {id: leadIds.join('&id=')}, headers: {'Content-Type': 'application/json'}});
  },
  ...
  isMember: function(listId, leadIds) {
    ...
    return this._connection.get(path, {query: {id: leadIds.join('&id=')}});
  },
